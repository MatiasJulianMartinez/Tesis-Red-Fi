...
const VistaProveedor = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto py-10 px-4 text-texto">
      <h1 className="text-3xl font-bold mb-4">{proveedor.nombre}</h1>
      ...
      {proveedor.reseñas && proveedor.reseñas.length > 0 ? (
        <div className="space-y-4">
          {proveedor.reseñas.map((r) => (
            ...
            >
              <p className="text-sm italic mb-2">“{r.comentario}”</p>
              <div className="flex justify-between text-sm text-gray-300">
                <span className="text-sm text-gray-300">— {r.user?.nombre || "Anónimo"}</span>
